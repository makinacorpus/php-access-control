...
use MakinaCorpus\AccessControl\Bridge\Symfony\DependencyInjection\Compiler\RegisterServiceMethodPass;
...
final class AccessControlBundle extends Bundle
{
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->addCompilerPass(new RegisterServiceMethodPass());
